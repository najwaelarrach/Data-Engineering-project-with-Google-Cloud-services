...
CLUSTER_NAME = os.environ.get('CLUSTER_NAME', 'new-york-taxi-airflowr')
GCP_PROJECT_ID = os.environ.get('GCP_PROJECT_ID', "gcp-pyspark-airflow")
REGION = os.environ.get('REGION', 'europe-west1')
ZONE = os.environ.get('ZONE', "europe-west1-d")

# check operator
BUCKET_NAME = os.environ.get('BUCKET_NAME', "gcp-pyspark-airflow")
TRIP_DATA_FILE_NAME_PREFIX = os.environ.get(
    'TRIP_DATA_FILE_NAME_PREFIX', "trip_data")
FARE_DATA_FILE_NAME_PREFIX = os.environ.get(
    'FARE_DATA_FILE_NAME_PREFIX', "fare_data")

# Others
TEMP_BUCKET = os.environ.get(
    'TEMP_BUCKET', "new-york-taxi-tutorial-project-temporary-bucket")
...
# Airflow DAG
with DAG(dag_id="new-york-taxi-pipeline", start_date=datetime(2023, 10, 31), schedule_interval="@monthly", default_args=default_args, tags=['new-york-taxi'], catchup=False) as dag:
